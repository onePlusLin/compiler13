...
"""Runtime NDArray api
张量在运行时的数据存储与移动，和设备（CPU/GPU）交互的核心数据类型。
"""
import ctypes
...
class NDArrayBase(object):
    ...
    """TVM NDArray的基类，封装C++层TVMArray的核心操作

    所有TVM张量类的父类，提供内存管理、形状获取、DLPack互转等基础功能。
    采用__slots__限制属性，提升内存效率和访问速度。
    """
