  ...
  namespace relay {
    namespace contrib {
      namespace ethosu {
        ...
        /*!
         * \brief This mutator 突变 removes identity operations that are not necessary. Specifically, an
        ...
        class RemoveRedundantIdentities : public MixedModeMutator {
          ...
          bool CheckIdentityBetweenTransformOperations(const Call& call, const Call& identity_call) {
            ...
            //如果当前的npu节点是reshape或者strided_slice，就判断identity的上一个节点是不是也是非计算节点
